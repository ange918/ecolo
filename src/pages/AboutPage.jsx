    ...
    <div style={{ background: '#0A0A0A' }}>
      ...
      <section className="min-h-[60vh] flex items-end px-6 lg:px-12 pb-20 pt-32"
        ...
        <div className="max-w-7xl mx-auto w-full">
          ...
          <motion.h1
            {...fadeUp(0.25)}
            style={{ fontFamily: 'Syncopate, sans-serif', fontWeight: 600, fontSize: 'clamp(2.2rem, 6vw, 5rem)', color: '#F5F0E8', lineHeight: 1.1, maxWidth: '800px' }}
          >
      ...
      <section className="py-24 lg:py-32 px-6 lg:px-12" style={{ background: '#111111' }}>
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <motion.div {...fadeUp(0)}>
            ...
            <h2 style={{ fontFamily: 'Syncopate, sans-serif', fontWeight: 600, fontSize: 'clamp(1.8rem, 3vw, 2.6rem)', color: '#F5F0E8', lineHeight: 1.2 }}>
      ...
      <section className="py-24 lg:py-32 px-6 lg:px-12" style={{ background: '#0A0A0A' }}>
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeUp(0)} className="mb-16 text-center">
            ...
            <h2 style={{ fontFamily: 'Syncopate, sans-serif', fontWeight: 600, fontSize: 'clamp(1.9rem, 3.5vw, 3rem)', color: '#F5F0E8' }}>
      ...
      <section className="py-24 lg:py-32 px-6 lg:px-12" style={{ background: '#0A0A0A' }}>
        <div className="max-w-4xl mx-auto text-center">
          <motion.div {...fadeUp(0)}>
            ...
            <h2 style={{ fontFamily: 'Syncopate, sans-serif', fontWeight: 600, fontSize: 'clamp(1.9rem, 3.5vw, 3rem)', color: '#F5F0E8', marginBottom: '2rem' }}>
