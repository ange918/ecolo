...
const realisations = [
  {
    ...
    svg: (
      <svg width="180" height="280" viewBox="0 0 180 280" fill="none" stroke="#C9A84C" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M68 85 C54 98 46 120 48 145" />
        <path d="M112 85 C126 98 134 120 132 145" />
        ...
        <circle cx="90" cy="50" r="5" fill="#C9A84C" fillOpacity="0.2" />
        <path d="M75 60 Q90 55 105 60" />
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg width="180" height="280" viewBox="0 0 180 280" fill="none" stroke="#C9A84C" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <ellipse cx="72" cy="95" rx="10" ry="13" />
        <ellipse cx="108" cy="95" rx="10" ry="13" />
        <path d="M75 130 Q90 140 105 130" />
        <path d="M50 80 L35 110 L45 115" />
        <path d="M130 80 L145 110 L135 115" />
        ...
        <path d="M44 250 Q90 240 136 250" strokeDasharray="5 3" />
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg width="180" height="280" viewBox="0 0 180 280" fill="none" stroke="#C9A84C" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M66 88 C50 104 42 130 44 158" />
        <path d="M114 88 C130 104 138 130 136 158" />
        <path d="M44 158 C34 168 28 180 30 195" />
        <path d="M136 158 C146 168 152 180 150 195" />
        <circle cx="90" cy="48" r="8" strokeDasharray="3 2" />
...
function Card({ item, delay }) {
  ...
  return (
    ...
    >
      ...
      >
        <p style={{ fontSize: '0.62rem', letterSpacing: '0.25em', textTransform: 'uppercase', color: '#C9A84C', marginBottom: '0.25rem', fontFamily: 'Jost' }}>
          {item.tag}
        </p>
        <p style={{ fontFamily: '"Cormorant Garamond", serif', fontWeight: 400, fontSize: '1.1rem', color: '#F5F0E8' }}>
          {item.titre}
        </p>
        <p style={{ fontFamily: 'Jost, sans-serif', fontWeight: 300, fontSize: '0.78rem', color: '#B8B0A0', marginTop: '0.2rem' }}>
          {item.sousTitre}
        </p>
      </div>
    </motion.div>
    ...
    <section id="realisations" className="py-24 lg:py-32 px-6 lg:px-12" style={{ background: '#111111' }}>
      <div className="max-w-7xl mx-auto">
        ...
        <p
          ...
          style={{ fontFamily: 'Jost, sans-serif', fontWeight: 300, fontSize: '0.9rem', color: '#B8B0A0', lineHeight: 1.8 }}
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {realisations.map((item, i) => (
            <Card key={i} item={item} delay={i * 0.15} />
          ))}
        </div>
      </div>
    </section>
