    ...
    <section id="galerie" className="py-24 lg:py-32 px-6 lg:px-12" style={{ background: '#111111' }}>
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 style={{ fontFamily: 'Syncopate, sans-serif', fontWeight: 600, fontSize: 'clamp(1.55rem, 5vw, 3.6rem)', color: '#F5F0E8', marginBottom: '1.5rem', lineHeight: 1.08, letterSpacing: '-0.01em' }}>
