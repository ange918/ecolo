        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-gray-300">
              Transformons les déchets en opportunités pour un avenir durable au Portugal.
            </p>
          </div>

          <div>
            <h4 className="font-montserrat font-semibold mb-4">Liens rapides</h4>
            <ul className="space-y-2">
              ...
              <li><Link to="/project" className="text-gray-300 hover:text-white transition-colors">Projet</Link></li>
              <li><Link to="/contact" className="text-gray-300 hover:text-white transition-colors">Contact</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="font-montserrat font-semibold mb-4">Mentions légales</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="font-montserrat font-semibold mb-4">Réseaux sociaux</h4>
